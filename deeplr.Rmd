...
num <- 7:8
left_top     <- c(0,100)
right_bottom <- c(0,1000)
pngs      <- paste0("D:/matu/work/ToDo/retc/img/", pkg,      "_0", num, ".png")
pngs_crop <- paste0("D:/matu/work/ToDo/retc/img/", pkg, "_crop_0", num, ".png")
magick::image_read(pngs) %>%
  automater::magick_crop(left_top, right_bottom) %>%
  as.list() %>%
...
en <- 
  ...
  purrr::map_chr(deeplr::translate2, 
    target_lang = "EN", auth_key = "your_api_key") %>%
  print()
