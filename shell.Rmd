...
res <- system(cmd, intern = TRUE)
head(res)
## [1] "Collecting PyAutoGUI"                                                            "  Downloading PyAutoGUI-0.9.53.tar.gz (59 kB)"
## [3] "     ---------------------------------------- 59.0/59.0 kB 1.6 MB/s eta 0:00:00" "  Installing build dependencies: started"
## [5] "  Installing build dependencies: finished with status 'done'"                    "  Getting requirements to build wheel: started"
tail(res)
## [1] "  Building wheel for pyrect (pyproject.toml): finished with status 'done'"
## [2] "  Created wheel for pyrect: filename=PyRect-0.2.0-py2.py3-none-any.whl size=11204 sha256=ad8e4de976213af2b4846873473791b65d3f4a7435c9424055c3a0e3b6d90bcc"
## [3] "  Stored in directory: c:\\users\\matutosi\\appdata\\local\\pip\\cache\\wheels\\c4\\e9\\fc\\b7a666dd4f9a3168fb44d643079b41d36ddab52f470707e820"
## [4] "Successfully built PyAutoGUI pygetwindow pyscreeze PyTweening mouseinfo pymsgbox pyperclip pyrect"
## [5] "Installing collected packages: PyTweening, pyscreeze, pyrect, pyperclip, pymsgbox, pygetwindow, mouseinfo, PyAutoGUI"
## [6] "Successfully installed PyAutoGUI-0.9.53 PyTweening-1.0.7 mouseinfo-0.1.3 pygetwindow-0.0.9 pymsgbox-1.0.9 pyperclip-1.8.2 pyrect-0.2.0 pyscreeze-0.1.28"
```
